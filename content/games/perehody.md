...
forWho:
  - Женщины в кризисе — когда прежние опоры перестали работать
  - Те, кто переживает развод, смену профессии или другой жизненный поворот
  - Те, кому важна поддерживающая атмосфера и глубокая трансформация
results:
...
process:
  - «Переходы» — это женская инициация через игровое поле. Работа идёт очно, в атмосфере принятия и безопасности.
  - "Я сопровождаю процесс как ведущая: задаю вопросы, помогаю исследовать образы и переживания, не давя и не торопя."
  - Индивидуальный формат — 1,5–2 часа, групповой — 3–4 часа (до 5 участниц).
---
